...
$tag_compiler_and_cmake_flags_sets = [
  ...
  [ 'gcc91-cpp17-boost1680-dbgstd', 'gcc',   '/opt/boost_1_68_0_gcc_c++14_build',   " -DCMAKE_C_COMPILER=${home_dir}/source/gcc/bin/gcc    -DCMAKE_C_COMPILER=${home_dir}/source/gcc/bin/g++        -DCMAKE_BUILD_TYPE=Debug -DCMAKE_CXX_FLAGS=' -std=c++17                -D_GLIBCXX_DEBUG=1                                              \${CMAKE_CXX_FLAGS} ' " ],
