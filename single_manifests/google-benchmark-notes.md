...
ninja -C ~/google-benchmark-clang-build -k 0 -j 4
ninja -C ~/google-benchmark-gcc-build   -k 0 -j 4
ninja -C ~/google-benchmark-clang-build -k 0 -j 4 install
ninja -C ~/google-benchmark-gcc-build   -k 0 -j 4 install
~~~