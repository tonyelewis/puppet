...
define boost ( $boost_version, $cpp_standard, $set_opt_include_symlink = false ) {
	...
	$tag_compiler_and_cmake_flags_sets = [
		...
		[  '9.3', 'normal', 'gcc',   "${home_dir}/source/gcc/bin/g++",      "                         cxxflags=\"-std=${cpp_standard}                                                                                                                                                                                                                      ${standard_specific_cxx_flags} \" linkflags=\"-std=${cpp_standard}                                                                                                                                                                                                                      -DBOOST_ASIO_HAS_STD_STRING_VIEW \" " ],
		[  '9.3', 'dbgchk', 'gcc',   "${home_dir}/source/gcc/bin/g++",      " define=_GLIBCXX_DEBUG=1 cxxflags=\"-std=${cpp_standard}                                                                                                                                                                                                                      ${standard_specific_cxx_flags} \" linkflags=\"-std=${cpp_standard}                                                                                                                                                                                                                      -DBOOST_ASIO_HAS_STD_STRING_VIEW \" " ],
		[  '9.3', 'ubasan', 'gcc',   "${home_dir}/source/gcc/bin/g++",      "                         cxxflags=\"-std=${cpp_standard}                -fsanitize=address -fsanitize=undefined -fno-omit-frame-pointer                                                                                                                                       ${standard_specific_cxx_flags} \" linkflags=\"-std=${cpp_standard}                -fsanitize=address -fsanitize=undefined -fno-omit-frame-pointer                                                                                                                                       -DBOOST_ASIO_HAS_STD_STRING_VIEW \" " ],
	]
